...
urls_file = 'collected_urls.txt'  # Change to your actual file path
...
with open('scraped_content_final.csv', 'w', newline='', encoding='utf-8') as csvfile:
...
print("Scraping completed and saved to scraped_content_final.csv")
